...
PTH_A_INT      EQU $C6    ; Minimum sensor detection value for A
PTH_B_INT      EQU $C0    ; Minimum sensor detection value for B        
PTH_C_INT      EQU $C6    ; Minimum sensor detection value for C
PTH_D_INT      EQU $C0    ; Minimum sensor detection value for D


PTH_E_INT      EQU $70   ; Differential E-F value where SENSOR_LINE < PTH_E_INT (robot must move right)
PTH_F_INT      EQU $72   ; Differential E-F value where SENSOR_LINE > PTH_F_INT (robot must move left)


  ; Displacement values 
INC_DIS        EQU 400   ; INCREMENT distance
FWD_DIS        EQU 400  ; FORWARD distance
REV_DIS        EQU 200  ; REVERSE distance
STR_DIS        EQU 1000  ; STRAIGHT distance
TRN_DIS        EQU 13500 ; TURN distance
UTRN_DIS       EQU 10000 ; U-TURN distance
...
RT_TRN         EQU 4 ; RIGHT TURN state value
LT_TRN         EQU 3; LEFT TURN state value
...
NO_FWD_BUMP:   BRSET PORTAD0,$08,NO_REAR_BUMP   ; Else if REV_BUMP, then 
               JMP   INIT_STND_BY               ; Initialize the standby state
