 ...
 */
package ryerson.ca.inventorysearch.Endpoint;
...
import ryerson.ca.inventorysearch.Business.SearchBusiness;
...
public class SearchResource {
    ...
    /**
     * Retrieves representation of an instance of ryerson.ca.inventorysearch.Endpoint.SearchResource
    ...
    public String getXml(@PathParam("query") String query) {
        ...
        ProductXML products = search.getProductsByQuery(query);
