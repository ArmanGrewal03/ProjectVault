...
<body>
   <div class="header">
       ...
       <% 
        ...
        out.println("<h1>Welcome, " + name + " to the Regional Manager Dashboard</h1>");  
       %>
   </div>
   <div class="dashboard-container">
       <div class="dashboard-options">
           <a href="view_store_info.jsp">View Store Information</a>
           <a href="manage_managers.jsp">Manage Store Managers</a>
       </div>
   </div>
</body>
</html>
